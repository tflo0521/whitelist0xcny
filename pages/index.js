    ...
    <div id="bodyy" className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <div >
          ...
          <div className="flex auth my-8 font-bold  justify-center items-center vw2">
            {!signedIn ? <button onClick={signIn} className="PalatinoLinotype inline-block border-1 border-black bg-white border-opacity-100 no-underline hover:text-white py-2 px-4 mx-4 shadow-lg hover:bg-red-900 hover:text-gray-100">Connect Wallet with Metamask</button>
            :
        ...
        <div className="md:w-2/3 w-4/5">
          ...
          <div className="mt-6 py-6">
            ...
            <div className="flex flex-col items-center">
                ...
                <span className="flex PalatinoLinotype text-4xl text-red-900 items-center bg-grey-lighter rounded rounded-r-none my-4 ">TOTAL MINTED:<span className="text-blau text-6xl"> {!signedIn ?  <>-</>  :  <>{totalSupply}</> } / 888</span></span>
