        ...
        <div className="md:w-2/3 w-4/5">
          ...
          <div className="mt-4 py-4">
            ...
            <div className="flex flex-col items-center">
                ...
                <span className="flex PalatinoLinotype text-4xl gold-color items-center bg-grey-lighter rounded rounded-r-none my-4 ">TOTAL MINTED: <span className="text-blau text-4xl"> {!signedIn ?  <>-</>  :  <>{totalSupply}</> } / 888</span></span>
...
<span className="flex PalatinoLinotype text-3xl gold-color items-center bg-grey-lighter rounded rounded-r-none my-4 ">Price: WL = 0.066 / Public = 0.088</span>
                ...
                <button onClick={() => mintbaby(how_many_babys)} className="mt-4 PalatinoLinotype text-2xl rounded-full border-6 bg-white text-black py-4 px-6 hover:text-red-900 ">MINT</button>        
                  : <button className="mt-4 PalatinoLinotype rounded-full text-2xl border-6 bg-white py-4 px-6 text-black hover:text-red-900">SALE IS NOT ACTIVE OR NO WALLET IS CONNECTED</button>        
