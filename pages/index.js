        ...
        <div className="md:w-2/3 w-4/5">
          ...
          <div className="mt-6 py-6">
            ...
            <div className="flex flex-col items-center">
               ...
               <span className="flex Poppitandfinchsans text-4xl text-yellow-100 items-center bg-grey-lighter rounded rounded-r-none my-4 ">First 750 free, max 20 per tx. Price: 0.02ETH</span>
